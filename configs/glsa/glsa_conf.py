...
data = dict(
    ...
    dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_prefix='data',
            ann_file='data/voc_train.data',
            pipeline=train_pipeline),
    ),
    val=dict(
        type=dataset_type,
        data_prefix='data',
        ann_file='data/voc_test.data',
...
evaluation = dict(interval=5, metric='accuracy',save_best='mAP')
...
custom_hooks = [
    dict(type='EpochAverageLossLoggerHook')
]
